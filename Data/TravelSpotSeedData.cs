...
public static class TravelSpotSeedData
{
    public static IReadOnlyList<TravelSpot> GetTravelSpots()
    {
        ...
        new() { Id = 68, Name = "   ", Location = "Samboan", Description = "Tall waterfall reached by a scenic river trek.", Category = "Waterfall", Region = "South Cebu" },
